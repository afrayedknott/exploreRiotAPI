...
class APIHandler(object):
    ...
    def assemble_dashboard(self):
        ...
        for key in path_params.keys():
            ...
            match path_params[key]['value_type']:
                ...
                case "int_iter" | "long": 
                    ...
                    temp_pp=pd.DataFrame(path_params[key]['starting_value'], columns=[key])
                    self.base_dashboard=self.base_dashboard.merge(temp_pp, how='cross')
        ...
        for key in query_params.keys():
            match query_params[key]['value_type']:
                ...
                case "int_iter" | "long": 
                    print(key + ": int_iter values pulled from info schema")
                    temp_pp=pd.DataFrame([query_params[key]['starting_value']], columns=[key])
                    self.base_dashboard=self.base_dashboard.merge(temp_pp, how='cross')
                case "databased": None # TODO: figure out what to do here
                case _: None
        ...
        match query_param_count:
            ...
            case 1:
                ...
                full_urls = [_ + self.param_delim + qp_keys[0] + self.qp_sep + query_params.get(qp_keys[0])['starting_value'] for _ in full_urls]
    ...
    def loop_through(self):
        ...
        curr_url = curr_dashboard_row['full_url'][0]
        first_int_iter = 1
            ...
            case 0:
                ...
                for index in self.base_dashboard.index[1:]:
                    while record_count >= self.full_page_record_count:
                        status_code = self.call_api(curr_url)
            ...
            case 1:
                ...
                for index in self.base_dashboard.index[1:]:
                    while record_count >= self.full_page_record_count:
                        ...
                        first_int_iter += 1
                        curr_url = self.url_updater(curr_url,
